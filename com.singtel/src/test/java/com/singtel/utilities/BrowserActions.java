...
public class BrowserActions {
	...
	public static void clickOnButton(String btn, WebDriver driver, String elementDescription) throws Exception {
		...
		WebElement element = driver.findElement(By.xpath(btn));
		if (!Utils.waitForElement(driver, element, 1))
			throw new Exception(elementDescription + " not found in page!!");
	 ...
	 */
	public static boolean elementDisplayed(WebDriver driver, WebElement SelectorForWebElement) {

		boolean displayed = false;

		try {
			displayed = SelectorForWebElement.isDisplayed();
		}
		catch (NoSuchElementException e) {
		}
	...
	public static String getText(WebDriver driver, String fromWhichTxtShldExtract, String elementDescription) throws Exception {
		...
		String textFromHTMLAttribute = "";
		WebElement element = driver.findElement(By.xpath(fromWhichTxtShldExtract));
	...
	public static void editExistingTodoItem(WebDriver driver, WebElement element, String editedTodo, String elementDescription) throws Exception{
		...
		try{
			...
			action.sendKeys(Keys.chord(Keys.CONTROL + editedTodo)).build().perform();
		}catch(NoSuchElementException e){
			throw new Exception(elementDescription + " not found in page!!");
		}
	}
	...
	public static void scrollToView(WebDriver driver) throws InterruptedException {
