...
public class Utils {
	 ...
	 */
	public static void waitForPageLoad(final WebDriver driver) throws InterruptedException {
	 ...
	 * @throws InterruptedException 
	 */
	public static void waitForPageLoad(final WebDriver driver, int maxWait) throws InterruptedException {
